		...
		return {
			...
			link: function(scope, elem, attrs) {
				...
				scope.upload = function() {
					...
					} else if (!_.isUndefined(attrs.resizeHeightWidth) && !attrs.resizeHeightWidth.match('([0-9]+x[0-9]+)')) {
	...
	.factory('FileManagerUploadFactory', function() {
            ...
            return {
                data: [
                    ...
                    {attribute: 'fileable_type', property: 'fileable_type', required: true, watch: true},
                    {attribute: 'fileable_id', property: 'fileable_id', required: true, watch: true},
                ],
                setting: [
                    {attribute: 'fileLabel'},
                    {attribute: 'nameLabel'},
